...
- Status: `not_started`
- Parent anchor: `mls-vast-exp14r2-w32-fold2-hybridsoft-repro`
...
1. Exp14r2 reaches a terminal `completed` state with finite CUDA metrics and a
...
2. Exp14r2 used the committed manifest without an uncommitted server override.
3. The fixed epoch-15 Exp14r2 metrics remain within these gross-drift guards of
...
All validated training fields are equal to Exp14r2 except:
