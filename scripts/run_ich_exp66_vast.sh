...
SMOKE_DIR="reports/ich_experiments/2p5d_segmentation/exp66_smoke_effnetv2s_sahpospix003_cap12_warm_exp61_schema4_f2"
FULL_DIR="reports/ich_experiments/2p5d_segmentation/exp66_effnetv2s_sahpospix003_cap12_warm_exp61_schema4_calonly_f2"
...
PYTHONPATH=. uv run python scripts/train_ich_2p5d_segmentation.py \
  --run-name ich-exp66-smoke-effnetv2s-sahpospix003-cap12-warm-exp61-schema4-f2 \
...
PYTHONPATH=. uv run python scripts/train_ich_2p5d_segmentation.py \
  --run-name ich-exp66-effnetv2s-sahpospix003-cap12-warm-exp61-schema4-calonly-f2 \
  --output-dir "$FULL_DIR" \
  --epochs 6 \
  --patience 3 \
...
PYTHONPATH=. uv run python scripts/evaluate_ich_sah_positive_pixel_gate.py \
