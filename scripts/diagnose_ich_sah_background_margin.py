...
def run_diagnostic(args: argparse.Namespace) -> dict[str, Any]:
    ...
    result = {
        "analysis_kind": "calibration_only_sah_background_margin_diagnostic",
    ...
    if args.notify:
        notify_campaign(
            ...
            "آزمایش مشخص می‌کند شکست exp65 از محدودیت دامنهٔ residual بوده یا از "
            "feature/optimization؛ outer همچنان دست‌نخورده است و آموزش تازه فقط "
            "براساس همین تشخیص انتخاب می‌شود.",
            experiment="exp65_postmortem_sah_margin",
