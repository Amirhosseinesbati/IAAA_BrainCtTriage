    ...
    *,
    ...
    return ExperimentManifest(
        ...
        hardware=HardwareSpec(
            ...
            min_price_per_hour=min_price_per_hour, max_price_per_hour=max_price_per_hour,
            min_reliability=min_reliability,
            min_download_mbps=min_download_mbps, max_download_mbps=max_download_mbps,
            min_cpu_cores=min_cpu_cores, max_cpu_cores=max_cpu_cores,
            top_k_enabled=top_k_enabled, top_k=top_k,
        ),
        runtime=RuntimeSpec(
